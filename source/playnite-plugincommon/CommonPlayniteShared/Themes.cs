...
using CommonPlayniteShared.Manifests;//using Playnite.API;
using CommonPlayniteShared.Extensions.Markup;//using Playnite.Extensions.Markup;
using System.Windows.Input;
using CommonPlayniteShared.Plugins;//using Playnite.Plugins;
